...
public class EmployeeController {
	...
	public String findAll(Model model){
		...
		List<Country> employeeList = employeeService.getEmployees();
		model.addAttribute("employees", employeeService.findAll());
		
		List<Country> jobtitleList = jobTitleService.getjobTitles();
		model.addAttribute("jobTitles", jobTitleService.findAll());
		
		List<Country> employeetypeList = employeeTypeService.getEmployeeType();
